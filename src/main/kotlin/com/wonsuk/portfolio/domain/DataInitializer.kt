package com.wonsuk.portfolio.domain
...
class DataInitializer(
    ...
    fun initializeData() {
        ...
        println("스프링 실행중입니다. 데이터를 초기화합니다.")
        // achievement 초기화
        ...
        val links = mutableListOf<Link>(
            Link(name = "Github", content = "https://github.com/lee-won-suk", isActive = true),
            Link(name = "Linkedin", content = "https://www.linkedin.com/in/leewonsuk/", isActive = true),
        )
